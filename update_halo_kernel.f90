...
CONTAINS
    ...
    SUBROUTINE update_halo_kernel(x_min, x_max, y_min, y_max, chunk_neighbours, &
            density, energy0, energy1, u, p, sd, fields, depth, offload, dev_id) 

        IMPLICIT NONE

        INTEGER :: j,k,l,dev_id
        INTEGER :: x_min,x_max,y_min,y_max, offload
        INTEGER, DIMENSION(4) :: chunk_neighbours
        REAL(KIND=8), DIMENSION(x_min-2:x_max+2,y_min-2:y_max+2) :: density,energy0,energy1,u,p,sd
